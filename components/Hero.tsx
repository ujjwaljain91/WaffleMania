...
const Marquee = () => (
  <div className="absolute top-20 left-0 w-full overflow-hidden opacity-[0.03] pointer-events-none select-none z-0">
    <motion.div
      className="whitespace-nowrap text-[12rem] font-black font-serif text-amber-950 leading-none"
      animate={{ x: ["0%", "-100%"] }}
...
export const Hero: React.FC = () => {
  ...
  // Text moves very slightly down and fades out
  ...
  return (
    <section className="relative min-h-[110vh] flex items-center pt-20 overflow-hidden bg-[#FFF9F0] perspective-[1000px]">
        {/* Background Elements */}
        ...
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <motion.div 
                ...
                className="order-2 lg:order-1 space-y-8 pb-10 lg:pb-0"
            >
                <motion.div 
                ...
                <div className="relative">
                    <h1 className="text-7xl lg:text-9xl font-serif font-black text-amber-950 leading-[0.85] tracking-tight">
                        <motion.span 
                        ...
                        <motion.span 
                             ...
                             className="block text-transparent bg-clip-text bg-gradient-to-r from-amber-600 via-orange-500 to-amber-700 italic pr-4"
                        >
                            GOLDEN
                        </motion.span>
                        <motion.span 
                    ...
                    {/* Decorative underlining squiggle */}
                    <motion.svg 
                        className="absolute -bottom-8 left-0 w-64 h-8 text-amber-400"
                        viewBox="0 0 200 20"
                ...
                <motion.p 
                    ...
                    className="text-xl text-amber-900/60 max-w-lg leading-relaxed font-medium"
                >
                ...
                >
                    <Button className="h-14 px-10 text-lg shadow-amber-900/20 shadow-2xl hover:scale-105 transition-transform">
                        Order Now
                    </Button>
                    <a href="#customizer" className="group flex items-center gap-2 text-amber-900 font-bold px-6 py-4 rounded-full hover:bg-amber-100/50 transition-colors">
                        Customize
            ...
            >
                ...
                >
                    ...
                    {/* Floating Strawberry */}
                    <FloatingElement delay={0} className="top-0 right-10 w-24 h-24 z-20" style={{ transform: "translateZ(100px)" }}>
                    ...
                    {/* Floating Blueberry */}
                    <FloatingElement delay={2} className="bottom-10 left-0 w-20 h-20 z-20" style={{ transform: "translateZ(80px)" }}>
                         <div className="w-full h-full rounded-full overflow-hidden shadow-2xl border-4 border-white/80">
                    ...
                    {/* Floating Card */}
                     <motion.div 
                        className="absolute bottom-[-10%] right-[-5%] bg-white/80 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white z-30 flex items-center gap-3"
                     ...
                     >
                        ...
                        <div>
                            <div className="text-xs font-bold text-amber-900/50 uppercase">Rating</div>
                            <div className="text-lg font-bold text-amber-900 leading-none">5.0 Stars</div>
                        </div>
                     </motion.div>

                     {/* Particle Effects behind */}
                     <div className="absolute inset-0 -z-10" style={{ transform: "translateZ(-50px)" }}>
                         <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-amber-500/20 blur-[100px] rounded-full" />
                     </div>
